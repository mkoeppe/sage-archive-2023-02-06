SAGE_SPKG_CONFIGURE([gfortran], [
    ...
    AC_FC_FREEFORM([
        ...
        dnl for openblas/spkg-configure.m4. We run this here because
        dnl AC_FC_FUNC needs to be wrapped in AC_FC_FREEFORM so
        dnl that there is no error if no Fortran compiler is installed;
        dnl and AC_FC_FREEFORM is AC_DEFUN_ONCE.
        AC_FC_FUNC([dgeqrf])
    ], [
