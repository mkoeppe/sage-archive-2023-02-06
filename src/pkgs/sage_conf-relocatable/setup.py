...
class build_py(setuptools_build_py):
    ...
    def run(self):
        ...
        try:
            ...
            cmd = f"cd {SAGE_ROOT} && {SETENV} && ./configure --prefix={SAGE_LOCAL} --with-sage-venv={SAGE_VENV} --with-python={sys.executable} --with-system-python3=force --with-mp=gmp --without-system-mpfr --without-system-readline --without-system-boost --without-system-boost_cropped --enable-download-from-upstream-url --enable-fat-binary --disable-notebook --disable-r --disable-doc"
